...
`NIST_SP-800-53_rev5_catalog.xml` is the local authoritative source for NIST control family names, control and enhancement titles, control statements, and organization-assigned parameter metadata used by the generated Rev5 Controls reference.
